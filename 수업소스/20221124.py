...
# 문자열 : 문자들이 모임. 문자 여러게. 문자의 배열
print("안녕하세요"[0])  #안
print("안녕하세요"[2])  #하

# 문자열의 범위를 지정하여 출력하기
# 문자열[첫번째인덱스:마지막인덱스+1:증감값]
print("안녕하세요"[0:2])  #안녕. 0번 인덱스부터 1번 인덱스까지
print("안녕하세요"[:2])  #안녕. 처음부터 1번 인덱스까지
print("안녕하세요"[:5:2])  #안하요. 처음부터 4번 인덱스까지 2칸씩
print("안녕하세요"[2:])  #하세요. 2번 인덱스 이후
print("안녕하세요"[::2])  #안하요.
print("안녕하세요"[::-1])  #요세하녕안. 뒤부터 앞으로
...
# input 함수 : 키보드에서 입력받기. 문자열형태로 입력받음.
